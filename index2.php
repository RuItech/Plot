...
<body>
   ...
   <div class="panel panel-body" style="background-color: #f2f2ed">
    ...
    <?php
     ...
     {
      echo  '<div class="panel panel-default panel-heading text-center" style="background-color: #3D7DDE"><b>Login</b></div>';
    }
    if  ($remarks=='failed')
    {
    ...
    <!-- <a href="https://wa.me/254702710739" class="float" target="_blank"> -->
        <a href="https://chat.whatsapp.com/GF5dXgF0v60EvYsj9aFtxw" class="float" target="_blank">
